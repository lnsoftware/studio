 ...
 * 已上架商品明细
 */
public class ProductOnShelfFragment extends BaseFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		List<WaitOnShelfItem> datas = (List<WaitOnShelfItem>)getActivity().getIntent().getSerializableExtra("onDatas");
